            ...
            <div class="container col-md-5">
				...
				<form id="formCustomer" name="formCustomer" method="post" action="Customer.jsp">  
					...
					<br>
					 ...
					 <br>
					 Date:  
					 <input id="customerDate" name="customerDate" type="text" class="form-control form-control-sm">  
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <h6>About</h6>
            <p class="text-justify">Avinash W.V.K <i> </i> This project is based on a company named Electrogrid who funds inventors and motivate them by letting them sell their products in the companies online platform. My task was to create the online platform covering the whole scope of the company. I used java , tomcat , mysql and JAX-RS Restful webservice as our tools to create our platform..</p>
          </div>
