...
public class CustomerApi extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String result = customerObj.insertCustomer(request.getParameter("customerName"),
				request.getParameter("customerAddress"), request.getParameter("customerEmail"), request.getParameter("customerDate"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String result = customerObj.updateCustomer(param.get("hidcustomerIDSave").toString(),
				...
				param.get("customerDate").toString().toString().replace("+", " "),
